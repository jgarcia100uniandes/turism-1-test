...
public class UseResource extends AuthService {
    ...
    private static final String CLIENT_HREF = "https://api.stormpath.com/v1/groups/yAWNHHo2KKxlRy7mdmVY9";
    private static final String AGENCY_HREF = "https://api.stormpath.com/v1/groups/17sNxjYJEeYN8qDMfuBIbh";    
